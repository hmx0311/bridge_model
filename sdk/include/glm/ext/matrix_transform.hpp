...
namespace glm
{
	...
	/// @endcode
	///
	/// @see - translate(viewMat<4, 4, T, Q> const& m, T x, T y, T z)
	...
	/// @tparam Q A value from qualifier enum
	///
	/// @see - rotate(viewMat<4, 4, T, Q> const& m, T angle, T x, T y, T z)
	...
	/// @tparam Q A value from qualifier enum
	///
	/// @see - scale(viewMat<4, 4, T, Q> const& m, T x, T y, T z)
    ...
    /// @tparam Q A value from qualifier enum
    ///
    /// @see - shear(viewMat<4, 4, T, Q> const& m, T x, T y, T z)
